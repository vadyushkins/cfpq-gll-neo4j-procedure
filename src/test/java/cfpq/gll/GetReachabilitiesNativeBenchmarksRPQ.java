...
public class GetReachabilitiesNativeBenchmarksRPQ {
    ...
    public void runTest(
        ...
        final String reg1 = Files.readString(
            Paths.get("src", "test", "resources", "grammar", "native", graph, "reg1.txt")
        ).replace("\n", "");
        final String reg2 = Files.readString(
            Paths.get("src", "test", "resources", "grammar", "native", graph, "reg2.txt")
        ).replace("\n", "");
        final String reg3 = Files.readString(
            Paths.get("src", "test", "resources", "grammar", "native", graph, "reg3.txt")
        ).replace("\n", "");
        final String reg4 = Files.readString(
            Paths.get("src", "test", "resources", "grammar", "native", graph, "reg4.txt")
        ).replace("\n", "");
        ...
        try (Session session = driver.session()) {
            ...
            for (String grammarName : new String[]{"reg1", "reg2", "reg3", "reg4"}) {
                ...
                File resultsDir = Paths.get("src", "test", "resources", "results", "native_rpq", graph).toFile();
                resultsDir.mkdirs();
